...
open class Carz(override val maxSpeed: Double,
...
class ElectricCarz(override val maxSpeed: Double,
                  override val brandName: String,
                  batteryLife: Double) : Carz(maxSpeed, brandName) {
...
fun main(args: Array<String>){
    var audiA3 = Carz(200.0, "Audi")
    var teslaS = ElectricCarz(250.0, "Tesla", 85.0)
